...
const statCards = [
  { id: 1, title: 'Faol talabalar', value: 52, icon: <SchoolOutlined sx={{ fontSize: 24, color: '#6d28d9' }} /> },
  { id: 2, title: 'Guruhlar', value: 23, icon: <GroupOutlined sx={{ fontSize: 24, color: '#6d28d9' }} /> },
  { id: 3, title: 'Joriy oy to\'lovlar', value: 0, icon: <CreditCardOutlined sx={{ fontSize: 24, color: '#6d28d9' }} /> },
  { id: 4, title: 'Qarzdorlar', value: 104, icon: <ReportProblemOutlined sx={{ fontSize: 24, color: '#6d28d9' }} /> },
  { id: 5, title: 'Muzlatilganlar', value: 0, icon: <AcUnitOutlined sx={{ fontSize: 24, color: '#6d28d9' }} /> },
  { id: 6, title: 'Arxivdagilar', value: 23, icon: <Inventory2Outlined sx={{ fontSize: 24, color: '#6d28d9' }} /> },
];
